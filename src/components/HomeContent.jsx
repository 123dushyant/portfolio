    ...
    return (
        ...
        <div className="text-center">
            ...
            <div className="mt-20 md:mt-8 sm:mt-6 lg:mt-8 xl:mt-20 ">
                <button onClick= {() => navigate('/about')} className="inline-block p-5 border-2 border-solid border-e-8 border-l-8 hover:bg-red-300 transform-gpu rounded-full bg-transparent w-20 h-20 md:w-16 md:h-16 sm:w-12 sm:h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 text-center transition-all duration-300 ease-in-out hover:scale-110">
